    ...
    <div className='bg-[#F8F7FC]'>
      <div className='container py-25'>
        ...
        <div className='flex gap-7.5 justify-center mt-[35px]'>
          <div className='w-92.5 h-[437px] p-[39px] flex flex-col items-center bg-[#FFFFFF] shadow-box hover:border-b-4 border-primary'>
          ...
          <div className='w-92.5 h-[437px] p-[39px] flex flex-col items-center bg-[#FFFFFF] shadow-box hover:border-b-4 border-primary'>
            ...
            <button className='flex text-primary items-center gap-1 font-nunito font-bold text-lg cursor-pointer'>
              Find A Home 
              <FaArrowRightLong/>
            </button>
          </div>
